...
// 2024-09-26 17:55:37.495696200 UTC
    ...
    pub mod schemas {
        ...
        pub mod client_dll {
            ...
            pub mod C_CSPlayerPawn {
                ...
                pub const m_flFlinchStack: usize = 0x22B8; // 
                pub const m_flVelocityModifier: usize = 0x22BC; // 
                pub const m_flHitHeading: usize = 0x22C0; // 
                pub const m_nHitBodyPart: usize = 0x22C4; // 
                pub const m_bWaitForNoAttack: usize = 0x22C8; // 
                pub const m_ignoreLadderJumpTime: usize = 0x22CC; // 
                pub const m_bKilledByHeadshot: usize = 0x22D1; // 
                pub const m_ArmorValue: usize = 0x22D4; // 
                pub const m_unCurrentEquipmentValue: usize = 0x22D8; // 
                pub const m_unRoundStartEquipmentValue: usize = 0x22DA; // 
                pub const m_unFreezetimeEndEquipmentValue: usize = 0x22DC; // 
                pub const m_nLastKillerIndex: usize = 0x22E0; // 
                pub const m_bOldIsScoped: usize = 0x22E4; // 
                pub const m_bHasDeathInfo: usize = 0x22E5; // 
                pub const m_flDeathInfoTime: usize = 0x22E8; // 
                pub const m_vecDeathInfoOrigin: usize = 0x22EC; // 
                pub const m_grenadeParameterStashTime: usize = 0x22F8; // 
                pub const m_bGrenadeParametersStashed: usize = 0x22FC; // 
                pub const m_angStashedShootAngles: usize = 0x2300; // 
                pub const m_vecStashedGrenadeThrowPosition: usize = 0x230C; // 
                pub const m_vecStashedVelocity: usize = 0x2318; // 
                pub const m_angShootAngleHistory: usize = 0x2324; // 
                pub const m_vecThrowPositionHistory: usize = 0x233C; // 
                pub const m_vecVelocityHistory: usize = 0x2354; // 
                pub const m_PredictedDamageTags: usize = 0x2370; // 
                pub const m_nPrevHighestReceivedDamageTagTick: usize = 0x23C0; // 
                pub const m_nHighestAppliedDamageTagTick: usize = 0x23C4; // 
            }
            ...
            pub mod CBasePlayerController {
                ...
                pub const m_nInButtonsWhichAreToggles: usize = 0x600; // 
                pub const m_nTickBase: usize = 0x608; // 
                pub const m_hPawn: usize = 0x60C; // 
                pub const m_bKnownTeamMismatch: usize = 0x610; // 
                pub const m_hPredictedPawn: usize = 0x614; // 
                pub const m_nSplitScreenSlot: usize = 0x618; // 
                ...
                pub const m_bIsHLTV: usize = 0x638; // 
                pub const m_iConnected: usize = 0x63C; // 
                pub const m_iszPlayerName: usize = 0x640; // 
                pub const m_steamID: usize = 0x6C8; // 
                pub const m_bIsLocalPlayerController: usize = 0x6D0; // 
                pub const m_iDesiredFOV: usize = 0x6D4; // 
            }
            // Parent: None
            // Field count: 0
            //
            ...
            pub mod C_CSGO_PreviewPlayer {
                pub const m_animgraph: usize = 0x23C8; // 
                pub const m_animgraphCharacterModeString: usize = 0x23D0; // 
                pub const m_flInitialModelScale: usize = 0x23D8; // 
            }
            ...
            pub mod C_BarnLight {
                ...
                pub const m_QueuedLightStyleStrings: usize = 0xD08; // 
                pub const m_LightStyleEvents: usize = 0xD20; // 
            ...
            pub mod C_EconEntity {
                ...
                pub const m_vecAttachedModels: usize = 0x1598; // 
            }
            // Parent: C_CSWeaponBaseGun
            // Field count: 0
            ...
            pub mod CPointTemplate {
                ...
                pub const m_clientOnlyEntityBehavior: usize = 0x590; // 
                pub const m_ownerSpawnGroupType: usize = 0x594; // 
            ...
            pub mod C_BaseFlex {
                pub const m_flexWeight: usize = 0xEE0; // 
                ...
                pub const m_PhonemeClasses: usize = 0x1008; // 
            }
            // Parent: C_BaseEntity
            // Field count: 1
            //
            ...
            pub mod C_BaseEntity {
                ...
                pub const m_vecVelocity: usize = 0x3E0; // 
            ...
            pub mod C_BreakableProp {
                ...
                pub const m_OnHealthChanged: usize = 0xF78; // 
            ...
            pub mod CCSWeaponBaseVData {
                ...
                pub const m_szHeatEffect: usize = 0x6B8; // 
                pub const m_szEjectBrassEffect: usize = 0x798; // 
                pub const m_szMuzzleFlashParticleAlt: usize = 0x878; // 
                pub const m_szMuzzleFlashThirdPersonParticle: usize = 0x958; // 
                pub const m_szMuzzleFlashThirdPersonParticleAlt: usize = 0xA38; // 
                pub const m_szTracerParticle: usize = 0xB18; // 
            ...
            pub mod C_PointWorldText {
                ...
                pub const m_nJustifyHorizontal: usize = 0xF34; // 
            ...
            pub mod CCSPlayerController {
                ...
                pub const m_iPing: usize = 0x720; // 
                pub const m_bHasCommunicationAbuseMute: usize = 0x724; // 
                pub const m_szCrosshairCodes: usize = 0x728; // 
                pub const m_iPendingTeamNum: usize = 0x730; // 
                pub const m_flForceTeamTime: usize = 0x734; // 
                pub const m_iCompTeammateColor: usize = 0x738; // 
                pub const m_bEverPlayedOnTeam: usize = 0x73C; // 
                pub const m_flPreviousForceJoinTeamTime: usize = 0x740; // 
                pub const m_szClan: usize = 0x748; // 
                pub const m_sSanitizedPlayerName: usize = 0x750; // 
                pub const m_iCoachingTeam: usize = 0x758; // 
                pub const m_nPlayerDominated: usize = 0x760; // 
                pub const m_nPlayerDominatingMe: usize = 0x768; // 
                pub const m_iCompetitiveRanking: usize = 0x770; // 
                pub const m_iCompetitiveWins: usize = 0x774; // 
                pub const m_iCompetitiveRankType: usize = 0x778; // 
                pub const m_iCompetitiveRankingPredicted_Win: usize = 0x77C; // 
                pub const m_iCompetitiveRankingPredicted_Loss: usize = 0x780; // 
                pub const m_iCompetitiveRankingPredicted_Tie: usize = 0x784; // 
                pub const m_nEndMatchNextMapVote: usize = 0x788; // 
                pub const m_unActiveQuestId: usize = 0x78C; // 
                pub const m_nQuestProgressReason: usize = 0x790; // 
                pub const m_unPlayerTvControlFlags: usize = 0x794; // 
                ...
                pub const m_bCannotBeKicked: usize = 0x7CC; // 
                pub const m_bEverFullyConnected: usize = 0x7CD; // 
                pub const m_bAbandonAllowsSurrender: usize = 0x7CE; // 
                pub const m_bAbandonOffersInstantSurrender: usize = 0x7CF; // 
                pub const m_bDisconnection1MinWarningPrinted: usize = 0x7D0; // 
                pub const m_bScoreReported: usize = 0x7D1; // 
                ...
                pub const m_bPawnIsAlive: usize = 0x7F4; // 
                pub const m_iPawnHealth: usize = 0x7F8; // 
                pub const m_iPawnArmor: usize = 0x7FC; // 
                pub const m_bPawnHasDefuser: usize = 0x800; // 
                pub const m_bPawnHasHelmet: usize = 0x801; // 
                pub const m_nPawnCharacterDefIndex: usize = 0x802; // 
                pub const m_iPawnLifetimeStart: usize = 0x804; // 
                pub const m_iPawnLifetimeEnd: usize = 0x808; // 
                pub const m_iPawnBotDifficulty: usize = 0x80C; // 
                pub const m_hOriginalControllerOfCurrentPawn: usize = 0x810; // 
                pub const m_iScore: usize = 0x814; // 
                pub const m_vecKills: usize = 0x818; // C_NetworkUtlVectorBase<EKillTypes_t>
                pub const m_bMvpNoMusic: usize = 0x830; // 
                pub const m_eMvpReason: usize = 0x834; // 
                pub const m_iMusicKitID: usize = 0x838; // 
                pub const m_iMusicKitMVPs: usize = 0x83C; // 
            ...
            pub mod C_RagdollProp {
                pub const m_ragPos: usize = 0xED8; // 
                pub const m_ragAngles: usize = 0xEF0; // 
